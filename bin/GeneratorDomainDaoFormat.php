...
";
   ...
   {
       require_once( __DIR__.'/{$schemaClassName}Format/{$tableClassName}Format.php');
       return new {$schemaClassName}Format\\{$tableClassName}Format();
   }";
                ...
                $tableCon[ 'header' ] = "<?php
namespace Wisp\DAO\\{$schemaClassName}Format;
use Wisp\Db\QueryBuild\IModel;
/**
* @description {$tabObj->comment}
**/
class {$tableClassName}Format extends IModel {
";
                //dbName
                ...
                de( $tableClassCon );
                //生成格式化文件
                $fileName = WispConfig::getGeneratorPath() . "/DAO/{$schemaClassName}Format/{$tableClassName}Format.php";
...
//     Util::de($tables);
            ...
            $fileName = WispConfig::getGeneratorPath() . "/DAO/{$schemaClassName}Format.php";
            de( $fileName );
