...
";
    ...
    AND table_name NOT LIKE 'tmp#_%' ESCAPE '#'";
            ...
            foreach ( $tables as $key => $table ) {
                ...
                //获取字段
                $sql = "select * from information_schema.COLUMNS where TABLE_SCHEMA='{$schemaName}' and TABLE_NAME='{$tabObj->tableName}'";
...
**/
class {$tableClassName} extends IModel {
";
                //dbName
                $tableCon[ 'schemaName' ] = "     \$this->__schemaName = '{$schemaName}';\n";
                //dbName
